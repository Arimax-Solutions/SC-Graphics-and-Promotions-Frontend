...
const Home = () => {
  ...
  <button
    ...
    className={`py-2 px-4 rounded-md text-white transition-all ${selectedCategory === 'All' ? 'bg-blue-700' : 'bg-blue-500 hover:bg-blue-600'}`}
  >
    All
  </button>
  {categories.map(category => (
    <button
      ...
      className={`py-2 px-4 rounded-md text-white transition-all ${selectedCategory === category.name ? 'bg-blue-700' : 'bg-blue-500 hover:bg-blue-600'}`}
    >
      {category.name}
    </button>
  ))}
...
<div className="lg:w-5/6 mx-auto">
  ...
  <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-8 justify-items-center">
